...
class FreshCommand extends Command {
	...
	public function fire()
	{
		...
		$files->delete(base_path('resources/views/layout/main.blade.php'));
		$files->delete(base_path('resources/views/layout/home.blade.php'));
		...
		$files->delete(base_path('database/migrations/2015_09_22_004245_create_usuarios_table.php'));
